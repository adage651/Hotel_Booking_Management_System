...
import AccountPopover from '../layout/dashboard/common/account-popover';
import LanguagePopover from '../layout/dashboard/common/language-popover';
            ...
            <Box sx={{ display: { sm: '', md: 'none' } }}>
              ...
              <Drawer anchor="right" open={open} onClose={toggleDrawer(false)}>
                ...
                >
                  ...
                  <MenuItem onClick={() => scrollToSection('our rooms')}>
                    Our Rooms
                  </MenuItem>
