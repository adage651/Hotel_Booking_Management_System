...
const selctedUser=async(user,userName)=>{
        ...
        body:JSON.stringify({sender:ctx.userName,receiver:user.userName})
    })
...
return contactDetail.contactData;    
 ...
 const sendMessage=async(e)=>{
    ...
    setSpecificMessage(prevValue=>{
        return [...prevValue,{sender:ctx.userName,receiver:selected.userName,message:inputValue,message_type:'sent'}]
    })
    const response= await fetch(`http://${process.env.REACT_APP_SERVERURL}/contact/sendMessage`,{
        ...
        body:JSON.stringify({sender:ctx.userName,receiver:selected.userName,message:inputValue})
    })
    }
                ...
                <div class="flex flex-column h-full">
                    <div class="flex align-items-center border-bottom-1 surface-border p-3 lg:p-6">
                        <div class="relative flex align-items-center mr-3">
                            <img
                                src={`http://${process.env.REACT_APP_SERVERURL}/public/uploads/${selected.profilePicture}`} alt="Ioni Bowcher"
                    ...
                    return  message.message_type!=="sent"?
                        ...
                        <div>
                            <div class="grid grid-nogutter mb-4">
                                <div class="mr-3 mt-1"><img src={`http://${process.env.REACT_APP_SERVERURL}/public/uploads/${selected.profilePicture}`} alt="Ioni Bowcher"
