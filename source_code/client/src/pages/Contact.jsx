                ...
                <div class="flex flex-column align-items-center border-bottom-1 surface-border p-6">
                    <img
                       src={ctx.profilePicture} class="w-6rem h-6rem border-circle shadow-4"
                        alt="Asiya Javayant" /><span class="text-900 text-xl font-semibold mt-4">{ctx.firstName+" "+ctx.lastName}</span>
                </div>
                <ScrollPanel style={{ width: '100%', height: '540px' }} class="w-full flex row-gap-4 flex-column surface-border p-4">
                    ...
                    <div class="flex flex-row gap-4 md:flex-column overflow-auto">
                        ...
                        {Object.keys(resData.users).map((userName)=>{
                           const user=resData.users[userName]
                        ...
                        <div onClick={()=>{selctedUser(user,userName)}} class="flex flex-nowrap justify-content-between align-items-center border-1 surface-border border-round p-3 cursor-pointer select-none hover:surface-hover transition-colors transition-duration-150"
                            ...
                            <div class="flex align-items-center">
                                <div class="relative md:mr-3"><img src={`http://${process.env.REACT_APP_SERVERURL}/public/uploads/${user.profilePicture}`}
...
selected.map(user=>{
    return( <div class="flex-1 card p-0">
                <div class="flex flex-column h-full">
                    <div class="flex align-items-center border-bottom-1 surface-border p-3 lg:p-6">
                        <div class="relative flex align-items-center mr-3"><img
                                src={`http://localhost:8000/public/uploads/${user.profilePicture}`} alt="Ioni Bowcher"
                        ...
                        <div class="mr-2"><span class="text-900 font-semibold block">{user.firstName+" "+user.lastName}</span><span
                        ...
                        <div class="flex align-items-center ml-auto"><button
                                ...
                                type="button" data-pc-name="button" data-pc-section="root"><span
                                    ...
                                    class="p-button-label p-c" data-pc-section="label">&nbsp;</span><span
                                    role="presentation" aria-hidden="true" class="p-ink" data-pc-name="ripple"
                                    data-pc-section="root" style={{height:"42px", width:"42px"}}></span></button></div>
                    </div>
                    <ScrollPanel class="p-3 md:px-4 lg:px-6 lg:py-4 mt-2 overflow-y-auto" style={{ width: '100%', height: '550px' ,overflowX:'clip'}}>
                        <div>
                            <div class="grid grid-nogutter mb-4">
                                <div class="mr-3 mt-1"><img src={`http://${process.env.REACT_APP_SERVERURL}/public/uploads/${user.profilePicture}`} alt="Ioni Bowcher"
                                        class="w-3rem h-3rem border-circle shadow-4" /></div>
                                <div class="col mt-3">
                                    <p class="text-900 font-semibold mb-3">{user.firstName+" "+user.lastName}</p><span
                                        class="text-700 inline-block font-medium border-1 surface-border p-3 white-space-normal border-round"
                                        style={{wordBreak:"breakWord" ,maxWidth:"80%"}}>Lorem ipsum dolor sit amet,
                        ...
                        <div>
                            <div class="grid grid-nogutter mb-4">
                                ...
                                <div class="col mt-3">
                                    <p class="text-900 font-semibold mb-3">{user.firstName+" "+user.lastName}</p><span
                                        class="text-700 inline-block font-medium border-1 surface-border p-3 white-space-normal border-round"
                                        style={{wordBreak:"breakWord;",maxWidth:"80%"}}>Sed do eiusmod tempor incididunt
                    ...
                    <div
                        ...
                        <input value={inputValue} onChange={handleInputChange}
                            ...
                            type="text"  />
    <div class="flex w-full sm:w-auto gap-3"><button onClick={(e) => {op.current.toggle(e); setShowEmojiPicker(true)}}
            ...
            data-pc-name="button" data-pc-section="root">😀<span role="presentation" aria-hidden="true" class="p-ink"
                ...
                style={{height: "58.8281px;", width: "58.8281px;"}}></span></button><button aria-label="Send"
            class="w-full sm:w-auto p-button p-component" data-pc-name="button" data-pc-section="root"><span
                class="p-button-icon p-c p-button-icon-left pi pi-send" data-pc-section="icon"></span><span
                class="p-button-label p-c" data-pc-section="label">Send</span><span role="presentation"
                ...
                style={{height: "93.6719px;", width: "93.6719px;"}}></span></button></div>
                     <OverlayPanel ref={op}> 
      {showEmojiPicker && <EmojiPicker onEmojiClick={handleEmojiClick} />}</OverlayPanel>
                    </div>
                </div>
            </div>)
}
